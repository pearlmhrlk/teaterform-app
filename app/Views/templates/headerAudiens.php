...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('public/assets/css/detail-penampilan.css') ?>">
    <link rel="stylesheet" href="<?= base_url('public/assets/css/detail-audisi.css') ?>">
        ...
        <!-- <div class="mobile-menu-modal" id="mobile-menu-modal">
            <div class="mobile-menu-content">
                ...
                <ul class="mobile-menu-list">
                    ...
                    <li>
                        <a href="<.?= base_url('Audiens/profile') ?>">
                            Profile
                        </a>
                    </li>
                    <li>
